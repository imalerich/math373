...
\solution
	...
	\begin{proof} \\
		...
		\bigbreak
		Note that by a generalization of the argument provided by $k=3$ we know that
		the quadrature formula will be true for all odd $k$, but for a degree of precision
		of $k$ we need it to be true for all integers less than $n$. Thus as the formula is 
